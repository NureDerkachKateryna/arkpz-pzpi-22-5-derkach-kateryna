        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkinIssue = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkincareRoutines", x => x.SkincareRoutineId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bans_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoutineProducts", x => x.RoutineProductId);
                    table.ForeignKey(
                        name: "FK_RoutineProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoutineProducts_SkincareRoutines_SkincareRoutineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoutineProducts_ProductId",
                table: "RoutineProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_RoutineProducts_SkincareRoutineId",
                table: "RoutineProducts",
