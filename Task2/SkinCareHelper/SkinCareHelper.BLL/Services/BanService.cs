...
namespace SkinCareHelper.BLL.Services
{
    public class BanService : IBanService
    {
        ...
        public BanService(IBanRepository productRepository, IUserRepository userRepository, ILogger<BanService> logger, IMapper mapper)
        {
            _banRepository = productRepository;
